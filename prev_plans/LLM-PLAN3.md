# Chess Engine Hackathon — Plan 3: "Build Your Opponent"

Builds on LLM-PLAN2. Changes from Plan 2:
- Rust-Python interface fully specified (new section)
- Replay semantics clarified: replay v1 = start a new game with the old eval
- Seconds-per-move is acceptable — no performance pressure on the bridge
- Stream A and Stream B deliverables updated to reflect the interface contract
